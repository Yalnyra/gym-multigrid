...
from algorithm.modules.agent_loaders.base_agent_loader import BaseAgentLoader
from algorithm.components.action_selectors import REGISTRY as action_REGISTRY
from algorithm.modules.agents import *
...
class RNNEvalAgentLoader(BaseAgentLoader):
    ...
    def predict(self, ep_batch, agent_idx, 
        ...
        chosen_actions = self.action_selector.select_action(agent_outs.squeeze(2), 
                                                            avail_actions.squeeze(2),
                                                            t_env, 
                                                            test_mode=test_mode)
